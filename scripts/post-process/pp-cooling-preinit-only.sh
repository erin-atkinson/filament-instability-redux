...
#SBATCH --time=4:00:00
#SBATCH --job-name=pp-strong-cooling-preinit-only
#SBATCH --output=../scratch/logs/filament-instability.post-process.strong-cooling-preinit-only.txt
...
export SIM_OUTPUT_FOLDER=../scratch/filament-instability-redux/cooling/strong-cooling-preinit-only
