...
#SBATCH --time=4:00:00
#SBATCH --job-name=pp-strong-cooling-no-init
#SBATCH --output=../scratch/logs/filament-instability.post-process.strong-cooling-no-init.txt
...
export SIM_OUTPUT_FOLDER=../scratch/filament-instability-redux/cooling/strong-cooling-no-init
